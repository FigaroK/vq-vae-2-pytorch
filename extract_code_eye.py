...
if __name__ == '__main__':
    ...
    os.environ["CUDA_VISIBLE_DEVICES"] = '1'# str(config.gpu_id)
    paths = config.img_path
    paths = glob(f"{paths}/all.h5")
    ...
    env = lmdb.open(os.path.join("lmdb", args.beta), map_size=map_size)
